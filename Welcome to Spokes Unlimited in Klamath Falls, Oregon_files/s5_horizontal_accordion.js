// s5_horizontal_accordion.js is copyrighted material by Shape5.com LLC 2010 - current
...
jQuery(document).ready(function() {
    ...
    function s5_hor_acc_open_1() {
        ...
        jQuery("#s5_hor_acc_second").animate({"left": s5_hor_acc_width - ((s5_hor_acc_module_counter - 1) * 40) + "px"},
          {queue:false, duration:duration, easing:easing});
        jQuery("#s5_hor_acc_third").animate({"left": s5_hor_acc_width - ((s5_hor_acc_module_counter - 2) * 40) + "px"},
            {queue:false, duration:duration, easing:easing});
		jQuery("#s5_hor_acc_fourth").animate({"left": s5_hor_acc_width - ((s5_hor_acc_module_counter - 3) * 40) + "px"},
            {queue:false, duration:duration, easing:easing});
		...
		jQuery("#s5_hor_acc_tenth").animate({"left": s5_hor_acc_width - ((s5_hor_acc_module_counter - 9) * 40) + "px"},
            {queue:false, duration:duration, easing:easing});
		jQuery("#s5_hor_acc_first").css({"background-image": "url(" + s5_hor_acc_url + "images/slide1.png)"});
		...
		jQuery("#s5_hor_acc_eighth").css({"background-image": "url(" + s5_hor_acc_url + "images/inactive.png)"});
	...
	function s5_hor_acc_open_8() {
		...
		jQuery("#s5_hor_acc_sixth").css({"background-image": "url(" + s5_hor_acc_url + "images/inactive.png)"});
		jQuery("#s5_hor_acc_seventh").css({"background-image": "url(" + s5_hor_acc_url + "images/inactive.png)"});
		jQuery("#s5_hor_acc_eighth").css({"background-image": "url(" + s5_hor_acc_url + "images/slide8.png)"});
		jQuery("#s5_hor_acc_ninth").css({"background-image": "url(" + s5_hor_acc_url + "images/inactive.png)"});
		jQuery("#s5_hor_acc_tenth").css({"background-image": "url(" + s5_hor_acc_url + "images/inactive.png)"});
